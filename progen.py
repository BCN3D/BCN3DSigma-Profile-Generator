    ...
    if validArguments():
        ...
        if len(sys.argv) == 1:
            ...
            while True:
                ...
                print ' 3. Profile for Cura 2.7 [Beta]'
                ...
                if x == '4':
                    ...
                    print '\t3. Generate profile files bundle - Cura 2.7 [Beta]'
                ...
                if x == '1':
                    ...
                    if x2 == '1':
                        ...
                        GUIHeader = title+'\n\n\n\n\n    Experimental features\n\n\n\n\n\t   Generate profile files bundle - Cura 2.7 [Beta]\n'
                    elif x2 == '4':
                        testComb = True
                ...
                if bundleProfilesSimplify3D or bundleProfilesCura or cura2FilesBundle or singleProfileSimplify3D or singleProfileCura or cura2Files:
                    if bundleProfilesSimplify3D:
                        ...
                        raw_input("\n\t\tCura 2.7 files created and zipped to share ;) Press Enter to continue...")
