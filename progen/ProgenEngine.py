...
def simplify3DProfile(hotendLeft, hotendRight, filamentLeft, filamentRight):
    ...
    fff.append(r'<profile name="'+fileName+r'" version="ProGen '+PS.progenVersionNumber+' (Build '+PS.progenBuildNumber+r')" app="S3D-Software 3.1.1">')
    ...
    for extruder in extruderPrintOptions:
        for quality in sorted(PS.profilesData['quality'], key=lambda k: k['index']):
            ...
            fff.append('  <autoConfigureQuality name="'+extruder+secondaryExtruderAction+str(quality['id'])+r'">')
            fff.append('    <globalExtrusionMultiplier>1</globalExtrusionMultiplier>')
            fff.append('    <fanSpeed>')
            fff.append('      <setpoint layer="1" speed="0" />')
            if primaryExtruder == 0:
                fff.append('      <setpoint layer="2" speed="'+str(fanSpeed(primaryHotend, primaryFilament, hotendLeftTemperature, layerHeight))+r'" />')
            else:
                fff.append('      <setpoint layer="2" speed="'+str(fanSpeed(primaryHotend, primaryFilament, hotendRightTemperature, layerHeight))+r'" />')
            fff.append('    </fanSpeed>')
            ...
            if hotendLeft['id'] != 'None':
                fff.append('    <extruder name="Left Extruder '+str(hotendLeft['nozzleSize'])+r'">')
                fff.append('      <toolheadNumber>0</toolheadNumber>')
                fff.append('      <diameter>'+str(hotendLeft['nozzleSize'])+'</diameter>')
                fff.append('      <autoWidth>0</autoWidth>')
                fff.append('      <width>'+str(hotendLeft['nozzleSize'] * 0.875)+'</width>')
                ...
                fff.append('    </extruder>')
            if hotendRight['id'] != 'None':
                fff.append('    <extruder name="Right Extruder '+str(hotendRight['nozzleSize'])+r'">')
                fff.append('      <toolheadNumber>1</toolheadNumber>')
                fff.append('      <diameter>'+str(hotendRight['nozzleSize'])+'</diameter>')
                fff.append('      <autoWidth>0</autoWidth>')
                fff.append('      <width>'+str(hotendRight['nozzleSize'] * 0.875)+'</width>')
            ...
            if hotendLeft['id'] != 'None':
                fff.append('    <temperatureController name="Left Extruder '+str(hotendLeft['nozzleSize'])+r'">')
                fff.append('      <temperatureNumber>0</temperatureNumber>')
                fff.append('      <isHeatedBed>0</isHeatedBed>')
                fff.append('      <relayBetweenLayers>0</relayBetweenLayers>')
                fff.append('      <relayBetweenLoops>0</relayBetweenLoops>')
                fff.append('      <stabilizeAtStartup>0</stabilizeAtStartup>')
                fff.append('      <setpoint layer="1" temperature="'+str(getTemperature(hotendLeft, filamentLeft, "highTemperature"))+r'"/>')
                fff.append('      <setpoint layer="2" temperature="'+str(hotendLeftTemperature)+r'"/>')
                fff.append('    </temperatureController>')
            if hotendRight['id'] != 'None':
                fff.append('    <temperatureController name="Right Extruder '+str(hotendRight['nozzleSize'])+r'">')
                fff.append('      <temperatureNumber>1</temperatureNumber>')
                fff.append('      <isHeatedBed>0</isHeatedBed>')
                fff.append('      <relayBetweenLayers>0</relayBetweenLayers>')
                fff.append('      <relayBetweenLoops>0</relayBetweenLoops>')
                fff.append('      <stabilizeAtStartup>0</stabilizeAtStartup>')
                fff.append('      <setpoint layer="1" temperature="'+str(getTemperature(hotendRight, filamentRight, "highTemperature"))+r'"/>')
                fff.append('      <setpoint layer="2" temperature="'+str(hotendRightTemperature)+r'"/>')
                fff.append('    </temperatureController>')
            if (hotendLeft['id'] != 'None' and filamentLeft['bedTemperature'] > 0) or (hotendRight['id'] != 'None' and filamentRight['bedTemperature'] > 0):
                fff.append('    <temperatureController name="Heated Bed">')
                fff.append('      <temperatureNumber>0</temperatureNumber>')
                ...
                fff.append('      <relayBetweenLoops>0</relayBetweenLoops>')
                fff.append('      <stabilizeAtStartup>0</stabilizeAtStartup>')
                fff.append('      <setpoint layer="1" temperature="'+str(bedTemperature)+r'"/>')
                fff.append('    </temperatureController>')
...
def cura2Profile():
    ...
    definition = []
    definition.append(r'{')
    definition.append(r'    "id": "'+PS.cura2id+r'",')
    definition.append(r'    "version": 2,')
    definition.append(r'    "name": "'+PS.cura2Name+r'",')
    definition.append(r'    "inherits": "fdmprinter",')
    definition.append(r'    "metadata": {')
    definition.append(r'        "author": "'+PS.cura2Author+r'",')
    definition.append(r'        "category": "'+PS.cura2Category+r'",')
    definition.append(r'        "manufacturer": "'+PS.cura2Manufacturer+r'",')
    definition.append(r'        "file_formats": "text/x-gcode",')
    definition.append(r'        "platform": "'+PS.cura2id+r'_bed.obj",')
    # definition.append(r'        "platform_texture": "'+PS.cura2id+r'backplate.png",')
    ...
    definition.append(r'        {')
    definition.append(r'            "0": "'+PS.cura2id+r'_extruder_left",')
    definition.append(r'            "1": "'+PS.cura2id+r'_extruder_right"')
    definition.append(r'        },')
    definition.append(r'        "first_start_actions": [ "'+PS.machineSettingsPluginName+r'" ],')
    definition.append(r'        "supported_actions": [ "'+PS.machineSettingsPluginName+r'" ]')
    definition.append(r'    },')
    definition.append(r'    "overrides": {')
    definition.append(r'        "machine_name": { "default_value": "'+PS.cura2Name+r'" },')
    ...
    extruder = []
    extruder.append(r'{')
    extruder.append(r'    "id": "'+PS.cura2id+r'_extruder_left",')
    ...
    extruder.append(r'        "machine": "'+PS.cura2id+r'",')
    ...
    extruder = []
    extruder.append(r'{')
    extruder.append(r'    "id": "'+PS.cura2id+r'_extruder_right",')
    extruder.append(r'    "version": 2,')
    ...
    for filament in sorted(PS.profilesData['filament'], key=lambda k: k['id']):
        ...
        material.append(r'           <machine_identifier manufacturer="'+PS.cura2Manufacturer+r'" product="'+PS.cura2id+r'" />')
        for hotend in sorted(PS.profilesData['hotend'], key=lambda k: k['id']):
            if hotend['id'] != 'None':
            ...
            for filament in sorted(PS.profilesData['filament'], key=lambda k: k['id']):
                for quality in sorted(PS.profilesData['quality'], key=lambda k: k['index']):
                    ...
                    if layerHeight not in globalQualities:
                        ...
                        qualityFile.append(r'definition = '+PS.cura2id)
                    ...
                    qualityFile.append(r'type = quality')
                    qualityFile.append(r'quality_type = layer'+("%.2f" % layerHeight)+'mm')
                    qualityFile.append(r'material = '+filament['brand'].replace(' ', '_')+'_'+filament['material'].replace(' ', '_')+'_'+PS.cura2id+'_'+hotend['id'].replace(' ', '_'))
                    ...
                    qualityFile.append(r'z_seam_type = random') 
                    qualityFile.append(r'z_seam_x = 105') 
                    qualityFile.append(r'z_seam_y = 297') 
                    # qualityFile.append(r'skin_no_small_gaps_heuristic = True') 

                    # infill
                    qualityFile.append(r'infill_sparse_density = ='+("%.2f" % min(100, quality['infillPercentage'] * 1.25))+' if infill_pattern == '+"'"+'cubicsubdiv'+"'"+r' else '+("%.2f" % quality['infillPercentage'])) # 'if' is not working...
                    qualityFile.append(r'infill_pattern = grid')
                    # qualityFile.append(r'infill_angles = []')
                    ...
                    # qualityFile.append(r'switch_extruder_extra_prime_amount = '+("%.2f" % filament['retractionSpeed'])) # Parameter that should be there to purge on toolchage
                    ...
                    # travel
                    qualityFile.append(r'retraction_combing = all')
                    # qualityFile.append(r'travel_retract_before_outer_wall = False')
                    qualityFile.append(r'travel_avoid_other_parts = False')
                    ...
                    qualityFile.append(r'layer_start_x = '+str(layerStartX)) # different than z_seam
                    qualityFile.append(r'layer_start_y = '+str(layerStartY)) # different than z_seam
    ...
    postProcessing.append(r'class '+PS.cura2PostProcessingPluginName.replace(' ','')+'(Script):')
    postProcessing.append(r'')
    ...
    postProcessing.append(r'            "name":"'+PS.cura2PostProcessingPluginName+r'",')
    postProcessing.append(r'            "key": "'+PS.cura2PostProcessingPluginName.replace(' ','')+r'",')
    ...
    postProcessing.append(r'')
    postProcessing.append(r'        startGcodeInfo = [";'+PS.cura2PostProcessingPluginName+' plugin enabled (Build '+PS.progenBuildNumber+')"]')
    postProcessing.append(r'')
    postProcessing.append(r'        # Do not change actions order as some may alter others')
    postProcessing.append(r'')
    ...
    postProcessing.append(r'                        if line.startswith("T0") or (line.startswith("T1") and printing):')
    ...
    postProcessing.append(r'                        elif "G" in line and "X" in line and "Y" in line and "E" in line:')
    ...
    postProcessing.append(r'                    break')
    postProcessing.append(r'')
    postProcessing.append(r'        if activeExtruders:')
    postProcessing.append(r'            startGcodeInfo.append("; - Heat only essentials")')
    postProcessing.append(r'            if not bothExtruders:')
    ...
    postProcessing.append(r'                                if line.startswith(idleExtruder) and line1.startswith("G92 E0") and line2.startswith("G1 E") and line3.startswith("G92 E0") and line4.startswith("G4 P2000") and line5.startswith("G1 F2400 E-8"):')
    ...
    postProcessing.append(r'            startGcodeInfo.append("; - Fix Tool Change Z Hop")')
    ...
    postProcessing.append(r'            startGcodeInfo.append("; - Fix First Extrusion")')
    postProcessing.append(r'            startGcodeCorrected = False')
    ...
    postProcessing.append(r'')
    postProcessing.append(r'        if fixTemperatureOscilation:')
    postProcessing.append(r'            startGcodeInfo.append("; - Fix Temperature Oscilation")')
    postProcessing.append(r'            if bothExtruders:')
    postProcessing.append(r'                # Scan all temperatures')
    postProcessing.append(r'                temperatures = [] # [(layerIndex, lineIndex, action, line)]')
    postProcessing.append(r'                for layer in data:')
    postProcessing.append(r'                    index = data.index(layer)')
    postProcessing.append(r'                    lines = layer.split("\n")')
    postProcessing.append(r'                    tempIndex = 0')
    postProcessing.append(r'                    while tempIndex < len(lines):')
    postProcessing.append(r'                        line = lines[tempIndex]')
    postProcessing.append(r'                        if layer.startswith(";LAYER:"):')
    postProcessing.append(r'                            if line.startswith("M109"):')
    postProcessing.append(r'                                temperatures.append([index, tempIndex, "heat", line])')
    postProcessing.append(r'                            elif line.startswith("T"):')
    postProcessing.append(r'                                temperatures.append([index, tempIndex, "toolChange", line])')
    postProcessing.append(r'                            elif line.startswith("M104"):')
    postProcessing.append(r'                                temperatures.append([index, tempIndex, "unknown", line])')
    postProcessing.append(r'                        tempIndex += 1')
    postProcessing.append(r'                # Define "unknown" roles')
    postProcessing.append(r'                for elementIndex in range(len(temperatures)):')
    postProcessing.append(r'                    action = temperatures[elementIndex][2]')
    postProcessing.append(r'                    if action == "unknown":')
    postProcessing.append(r'                        if temperatures[elementIndex][3].startswith("M104 T"):')
    postProcessing.append(r'                            tempIndex = elementIndex -1')
    postProcessing.append(r'                            while tempIndex >= 0:')
    postProcessing.append(r'                                if temperatures[tempIndex][3].startswith("T"):')
    postProcessing.append(r'                                    action = "coolDownIdle"')
    postProcessing.append(r'                                    break')
    postProcessing.append(r'                                elif temperatures[tempIndex][3].startswith("M104 T"):')
    postProcessing.append(r'                                    action = "preheat"')
    postProcessing.append(r'                                    break')
    postProcessing.append(r'                                tempIndex -= 1')
    postProcessing.append(r'                        elif temperatures[elementIndex][3].startswith("M104 S"):')
    postProcessing.append(r'                            if elementIndex + 1 < len(temperatures):')
    postProcessing.append(r'                                if temperatures[elementIndex + 1][3].startswith("T"):')
    postProcessing.append(r'                                    action = "coolDownActive"')
    postProcessing.append(r'                                else:')
    postProcessing.append(r'                                    action = "setpoint"')
    postProcessing.append(r'                        temperatures[elementIndex][2] = action')
    postProcessing.append(r'                # Correct all temperatures            ')
    postProcessing.append(r'                for elementIndex in range(len(temperatures)):')
    postProcessing.append(r'                    action = temperatures[elementIndex][2]')
    postProcessing.append(r'                    if action == "preheat":')
    postProcessing.append(r'                        tempIndex = elementIndex + 1')
    postProcessing.append(r'                        while tempIndex < len(temperatures):')
    postProcessing.append(r'                            if temperatures[tempIndex][2] == "preheat":')
    postProcessing.append(r'                                break')
    postProcessing.append(r'                            elif temperatures[tempIndex][2] == "setpoint":')
    postProcessing.append(r'                                correctTemperatureValue = self.getValue(temperatures[tempIndex][3], "S") - '+str(temperatureInertiaInitialFix))
    postProcessing.append(r'                                temperatures[elementIndex][3] = temperatures[elementIndex][3].split("S")[0]+"S"+str(correctTemperatureValue)')
    postProcessing.append(r'                                break')
    postProcessing.append(r'                            tempIndex += 1')
    postProcessing.append(r'                    elif action == "heat":')
    postProcessing.append(r'                        tempIndex = elementIndex - 1')
    postProcessing.append(r'                        while tempIndex >= 0:')
    postProcessing.append(r'                            if temperatures[tempIndex][2] == "preheat":')
    postProcessing.append(r'                                correctTemperatureValue = self.getValue(temperatures[tempIndex][3], "S")')
    postProcessing.append(r'                                temperatures[elementIndex][3] = temperatures[elementIndex][3].split("S")[0]+"S"+str(correctTemperatureValue)')
    postProcessing.append(r'                                break')
    postProcessing.append(r'                            tempIndex -= 1')
    postProcessing.append(r'                    elif action == "coolDownIdle":')
    postProcessing.append(r'                        correctTemperatureValue = max(self.getValue(temperatures[elementIndex][3], "S") - '+str(temperatureInertiaInitialFix)+', '+("%.2f" % standbyTemperature)+')')
    postProcessing.append(r'                        temperatures[elementIndex][3] = temperatures[elementIndex][3].split("S")[0]+"S"+str(correctTemperatureValue)')
    postProcessing.append(r'                    elif action == "coolDownActive":')
    postProcessing.append(r'                        tempIndex = elementIndex - 1')
    postProcessing.append(r'                        while tempIndex >= 0:')
    postProcessing.append(r'                            if temperatures[tempIndex][2] == "coolDownActive":')
    postProcessing.append(r'                                break                        ')
    postProcessing.append(r'                            if temperatures[tempIndex][2] == "setpoint":')
    postProcessing.append(r'                                correctTemperatureValue = self.getValue(temperatures[tempIndex][3], "S") - '+str(temperatureInertiaFinalFix))
    postProcessing.append(r'                                temperatures[elementIndex][3] = temperatures[elementIndex][3].split("S")[0]+"S"+str(correctTemperatureValue)')
    postProcessing.append(r'                                break')
    postProcessing.append(r'                            tempIndex -= 1')
    postProcessing.append(r'                # Set back new corrected temperatures')
    postProcessing.append(r'                for layer in data:')
    postProcessing.append(r'                    index = data.index(layer)')
    postProcessing.append(r'                    lines = layer.split("\n")')
    postProcessing.append(r'                    correctionsApplied = 0')
    postProcessing.append(r'                    tempIndex = 0')
    postProcessing.append(r'                    while tempIndex < len(lines) and len(temperatures) > 0:')
    postProcessing.append(r'                        if index == temperatures[0][0] and tempIndex == temperatures[0][1]:')
    postProcessing.append(r'                            lines[tempIndex] = temperatures[0][3]')
    postProcessing.append(r'                            del temperatures[0]')
    postProcessing.append(r'                        tempIndex += 1')
    postProcessing.append(r'                    layer = "\n".join(lines)')
    postProcessing.append(r'                    data[index] = layer')
    postProcessing.append(r'')
    ...
    postProcessing.append('                data[index] = layer')
    postProcessing.append(r'')
    postProcessing.append(r'        # Write '+PS.cura2PostProcessingPluginName+' info')
    postProcessing.append(r'        for layer in data:')
    postProcessing.append(r'            index = data.index(layer)')
    postProcessing.append(r'            lines = layer.split("\n")')
    postProcessing.append(r'            for tempIndex in range(len(lines)):')
    postProcessing.append(r'                if layer.startswith(";Generated with Cura_SteamEngine ") and lines[tempIndex].startswith(";Sigma ProGen"):')
    postProcessing.append(r'                    lines[tempIndex] = lines[tempIndex]+"\n"+"\n".join(startGcodeInfo)')
    postProcessing.append(r'            layer = "\n".join(lines)')
    postProcessing.append(r'            data[index] = layer')
    postProcessing.append(r'')
    ...
    sigmaSettings = []
    sigmaSettings.append(r'from . import '+PS.machineSettingsPluginName)
    ...
    sigmaSettings.append(r'    return { "machine_action": '+PS.machineSettingsPluginName+'.'+PS.machineSettingsPluginName+'() }')
    fileContent = '\n'.join(sigmaSettings)
    filesList.append((fileName, fileContent))
    ...
    sigmaSettings.append(r'class '+PS.machineSettingsPluginName+'(MachineAction):')
    sigmaSettings.append(r'    def __init__(self, parent = None):')
    sigmaSettings.append(r'        super().__init__("'+PS.machineSettingsPluginName+r'", catalog.i18nc("@action", "Sigma Settings"))')
    sigmaSettings.append(r'        self._qml_url = "'+PS.machineSettingsPluginName+r'.qml"')
    sigmaSettings.append(r'')
    ...
    sigmaSettings.append(r'                Logger.log("d", "Not attaching '+PS.machineSettingsPluginName+r' to %s; Multi-extrusion printers are not supported", container.getId())')
    sigmaSettings.append(r'                return')
    sigmaSettings.append(r'')
    ...
    sigmaSettings.append(r'            width: parent.width')
    sigmaSettings.append(r'            wrapMode: Text.WordWrap')
    sigmaSettings.append(r'            visible: "'+PS.cura2Name+r'" in Cura.MachineManager.activeMachineId')
    sigmaSettings.append(r'            text: catalog.i18nc("@label", "Attention! In order to get the best results with your BCN3D Sigma, please make sure the '+PS.cura2PostProcessingPluginName+r' plugin is enabled under Extensions > Post Processing > Modify G-Code.")')
    sigmaSettings.append(r'        }')
    sigmaSettings.append(r'')
    ...
    sigmaSettings.append(r'                        CheckBox')
    sigmaSettings.append(r'                        {')
    sigmaSettings.append(r'                            id: autoTemperatureCheckBox')
    sigmaSettings.append(r'                            text: catalog.i18nc("@option:check", "Enable setting: Auto Temperature")')
    sigmaSettings.append( "                            checked: String(machineAutoTemperatureProvider.properties.enabled).toLowerCase() != 'false'")
    sigmaSettings.append(r'                            onClicked: machineAutoTemperatureProvider.setPropertyValue("enabled", checked)')
    sigmaSettings.append(r'                        }')
    sigmaSettings.append(r'                    }')
    sigmaSettings.append(r'                }')
    sigmaSettings.append(r'')
    ...
    sigmaSettings.append(r'    UM.SettingPropertyProvider')
    sigmaSettings.append(r'    {')
    sigmaSettings.append(r'        id: machineAutoTemperatureProvider')
    sigmaSettings.append(r'')
    sigmaSettings.append(r'        containerStackId: Cura.MachineManager.activeMachineId')
    sigmaSettings.append(r'        key: "material_flow_dependent_temperature"')
    sigmaSettings.append(r'        watchedProperties: [ "enabled" ]')
    sigmaSettings.append(r'        storeIndex: manager.containerIndex')
    sigmaSettings.append(r'    }')
    sigmaSettings.append(r'')
