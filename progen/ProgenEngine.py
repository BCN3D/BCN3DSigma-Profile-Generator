...
def cura2Profile():
    ...
    postProcessing.append(r'                    "default_value": true')
    postProcessing.append(r'                },')
    postProcessing.append(r'                "minimumExtrusion":')
    postProcessing.append(r'                {')
    postProcessing.append(r'                    "label": "Minimum Extrusion",')
    postProcessing.append(r'                    "description": "Minimum filament length to be extruded in the layer to avoid purge.",')
    postProcessing.append(r'                    "unit": "mm",')
    postProcessing.append(r'                    "type": "float",')
    postProcessing.append(r'                    "default_value": 1.5,')
    postProcessing.append(r'                    "minimum_value": "0",')
    postProcessing.append(r'                    "minimum_value_warning": "0",')
    postProcessing.append(r'                    "maximum_value_warning": "50",')
    ...
    postProcessing.append(r'        minimumExtrusion = self.getSettingValueByKey("minimumExtrusion")')
    postProcessing.append(r'')
    ...
    postProcessing.append(r'            startGcodeInfo.append("; - SmartPurge")')
    postProcessing.append(r'            if bothExtruders:')
    postProcessing.append(r'                extraPurges = []')
    postProcessing.append(r'                for layer in data:')
    postProcessing.append(r'                    index = data.index(layer)')
    postProcessing.append(r'                    lines = layer.split("\n")')
    postProcessing.append(r'                    tempIndex = 0')
    postProcessing.append(r'                    while tempIndex < len(lines):')
    postProcessing.append(r'                        if layer.startswith(";LAYER:") and (lines[tempIndex].startswith("T0") or lines[tempIndex].startswith("T1")):')
    postProcessing.append(r'                            lineCount = tempIndex - 1')
    postProcessing.append(r'                            while lineCount >= 0:')
    postProcessing.append(r'                                line = lines[lineCount]')
    postProcessing.append(r'                                if "G" in line and "F" in line and "E" in line and self.getValue(line, "E") < minimumExtrusion:')
    postProcessing.append(r'                                    extraPurges.append(index - 1)')
    postProcessing.append(r'                                    break')
    postProcessing.append(r'                                lineCount -= 1')
    postProcessing.append(r'                            break')
    postProcessing.append(r'                        tempIndex += 1')
    ...
    postProcessing.append(r'                    index = data.index(layer)')
    postProcessing.append(r'                    lines = layer.split("\n")')
    postProcessing.append(r'                    applyFix = False')
    postProcessing.append(r'                    if len(extraPurges) > 0:')
    postProcessing.append(r'                        if index == extraPurges[0]:')
    postProcessing.append(r'                            tempIndex = 0')
    postProcessing.append(r'                            while tempIndex < len(lines):')
    postProcessing.append(r'                                if lines[tempIndex].startswith("T0") or lines[tempIndex].startswith("T1"):')
    postProcessing.append(r'                                    applyFix = True')
    postProcessing.append(r'                                elif applyFix and lines[tempIndex].startswith("M109 S"):')
    postProcessing.append(r'                                    lines[tempIndex] = lines[tempIndex] + "\nG1 F2400 E"+str(8)+"\nG1 F100 E"+str(8+1.5)+"\nG4 P2000\nG1 F2400 E"+str(1.5)+"\nG92 E0"')
    postProcessing.append(r'                                    break')
    postProcessing.append(r'                                tempIndex += 1')
    postProcessing.append(r'                            del extraPurges[0]')
    postProcessing.append(r'                    layer = "\n".join(lines)')
    postProcessing.append(r'                    data[index] = layer')
    postProcessing.append(r'')
    ...
    postProcessing.append(r'                            lines[tempIndex] = temperatures[0][3]#+" ;"+temperatures[0][2]')
