...
def cura2Profile():
    ...
    postProcessing.append('                                if "G" in line and "F" in line and "E" in line and self.getValue(line, "E") < minimumExtrusion[abs(countingForTool-1)]:')
    ...
    postProcessing.append('                                        lineCount += 1')
    postProcessing.append('                                        if "G1" in lines[lineCount] and "F" in lines[lineCount] and "X" in lines[lineCount] and "Y" in lines[lineCount] and "E" in lines[lineCount]:')
    postProcessing.append('                                            lineCount = tempIndex')
    postProcessing.append('                                            break')
    postProcessing.append(r'                                    lines[tempIndex] = lines[tempIndex] + "\nM104 S"+str(self.getValue(lines[lineCount], "S"))+"\nG1 F2400 E"+str(8)+"\nG1 F50 E"+str(8+purgeLength[countingForTool])+"\nG4 P2000\nG1 F2400 E"+str(purgeLength[countingForTool])+"\nG92 E0"')
    postProcessing.append('                                    break')
    postProcessing.append('                                tempIndex += 1')
    ...
    postProcessing.append('                        correctTemperatureValue = max(self.getValue(temperatures[elementIndex][3], "S") + '+str(temperatureInertiaInitialFix)+', '+str(int(standbyTemperature))+')')
    postProcessing.append('                        temperatures[elementIndex][3] = temperatures[elementIndex][3].split("S")[0]+"S"+str(correctTemperatureValue)')
